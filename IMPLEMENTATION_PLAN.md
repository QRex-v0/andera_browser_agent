...
2. Codex reviews it and establishes the baseline eval score. **Done:** 13/13 tests pass; PR #4 is merge-ready.
...
This is the shipped fixture-backed vertical slice. It is the smallest working evidence-collection loop, not the architecture in §§3–4.

### Shipped

- Branch: `cursor/mvp-vertical-slice`
- PR: https://github.com/QRex-v0/andera_browser_agent/pull/4 (merge-ready after Codex re-review)
...
Playwright remains an explicit known limitation for this PR. Default tests stay on the fixture backend.
